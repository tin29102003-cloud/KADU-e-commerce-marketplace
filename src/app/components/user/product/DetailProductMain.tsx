          ...
          <div className="detailPrd--main__info col-7">
            ...
            <div className="detailPrd--meta flex items-center mt-3">
              <div className="detailPrd--meta__item rating flex items-center gap-x-1">
                <span className="rating__count text-accentColor">5</span>
                <div className="rating__star flex items-center gap-x-1">
                  <FaStar className="w-4 h-4 fill-[#FFC205]" />
                  <FaStar className="w-4 h-4 fill-[#FFC205]" />
                  <FaStar className="w-4 h-4 fill-[#FFC205]" />
                  <FaStar className="w-4 h-4 fill-[#FFC205]" />
                  <FaStar className="w-4 h-4 fill-[#FFC205]" />
              ...
              <div className="detailPrd--meta__item reviews flex items-center gap-x-1 ">
                ...
                <span className="reviews__count text-accentColor">128</span>
              </div>
            ...
            <div className="detailPrd--action mt-6">
              ...
              <div className="flex gap-x-3">
                ...
                <div className="blockBtn--buy flex-grow grid grid-cols-3 gap-x-3">
                  <BtnPrimary
                    className="btn--buyNow col-span-2"
                    content="Thêm vào giỏ"
                    data-id={product.id}
                    onClick={(e) => handleAddTocart(e)}
                  />
                  <BtnSecondary
                    className="btn--addCart col-span-1"
                    content="Mua ngay"
                  />
                </div>
              </div>
